...
\citep{schar2021defi}. Broader claims about coupling and failure propagation
require evidence from complex-systems and socio-technical failure research
rather than generalization from that domain. \textbf{[REFERENCE NEEDED:
complex-system coupling and socio-technical failure]}
...
contestable, or accountable. \textbf{[REFERENCE NEEDED: algorithmic
accountability and institutional audit]}
...
\citep{tabassi2023airmf,amershi2019guidelines}, while the design of
independent appeals and capture resistance requires additional support.
\textbf{[REFERENCE NEEDED: contestability and institutional appeals]}
