...
\hypersetup{
  ...
  pdfsubject={Private pre-publication academic review copy; distribution not authorized},
...
Private pre-publication academic review material. Package ID:
\texttt{AXODUS-V0.6-CHR-EN-20260712}. Not authorized for public circulation,
reposting, forwarding, publication, submission, partnership presentation,
fundraising, investor use, or training use. Reviewer delivery requires a
separate named authorization. Controlled review does not imply endorsement,
validation, acceptance, or peer-review completion.}}
\end{center}
